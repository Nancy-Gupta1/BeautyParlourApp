...
class MakeupSliderAdapter(
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val viewItem = inflater.inflate(R.layout.item_detailmakeup_adapter, container, false)
        //finding id
        val imageView = viewItem.findViewById<ImageView>(R.id.imageViewMakeUp)
