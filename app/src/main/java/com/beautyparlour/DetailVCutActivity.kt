...
import kotlinx.android.synthetic.main.activity_details_u_cut.txtUappoint
import kotlinx.android.synthetic.main.custom_toolbar.*
import java.util.*

class DetailVCutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_detail_v_cut)
        val toolbar: Toolbar = findViewById(R.id.toolbar1)
        setSupportActionBar(toolbar)
        toolbarName.text = "V cut"
        initView()
    }
    ...
    private fun initView() {
        ...
        txtVappoint.setOnClickListener {
            startActivity(Intent(this@DetailVCutActivity, AppoinmentActivity::class.java))
        }
        sliderDotspanel = findViewById(R.id.detailMakeupviewpagerSliderDotsHome)
        viewPager = findViewById(R.id.detailMakeupviewpager)
        adapter = MakeupSliderAdapter(this@DetailVCutActivity, imageId , imagesName)
